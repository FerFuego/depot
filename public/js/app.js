...
$(document).ready(function () {
  ...
  var permissions_checkbox_list = $('#permissions_checkbox_list'); //permissions_box.hide()
  ...
  $('#role').on('change', function () {
    ...
    $.ajax({
      ...
      $.each(data, function (index, element) {
        $(permissions_checkbox_list).append('<div class="custom-control custom-checkbox">' + '<input type="checkbox" name="permissions[]" class="custom-control-input" id="' + element.slug + '" value="' + element.id + '">' + '<label for="' + element.slug + '" class="custom-control-label">' + element.name + '</label>' + '</div>');
      });
    });
  });
});
...
module.exports = __webpack_require__(/*! C:\wamp\www\depot\resources\js\app.js */"./resources/js/app.js");
